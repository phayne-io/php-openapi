...
use Phayne\OpenAPI\Specification\Discriminator;
...
JSON
        ...
        $this->assertEquals([], $schema->errors());
...
YAML
    ...
    public static function badSchemaProvider(): Generator
    {
        yield [['properties' => ['a' => 'foo']], 'Unable to instantiate Phayne\OpenAPI\Specification\Schema Object with data \'foo\''];
        yield [['properties' => ['a' => 42]], 'Unable to instantiate Phayne\OpenAPI\Specification\Schema Object with data \'42\''];
        yield [['properties' => ['a' => false]], 'Unable to instantiate Phayne\OpenAPI\Specification\Schema Object with data \'\''];
        yield [['properties' => ['a' => new stdClass()]], "Unable to instantiate Phayne\OpenAPI\Specification\Schema Object with data 'stdClass Object\n(\n)\n'"];
